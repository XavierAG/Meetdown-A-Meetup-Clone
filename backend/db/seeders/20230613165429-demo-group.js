...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    return queryInterface.bulkInsert(options, [
    {
      ...
      about: "Start your day with a rejuvenating yoga session in the park. All levels welcome.",
      type: "In person",
      private: false,
      city: "San Francisco",
      state: "CA"
    ...
    },
    {
      ...
      about: "Explore the scenic trails and breathtaking landscapes on our group hikes. All skill levels welcome!",
      type: "In person",
      private: false,
      city: "Denver",
      state: "CO"
